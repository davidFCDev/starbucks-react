const Stars = () => {
  return (
    <main>
      <div className="bg-sb-gray flex flex-col px-10 py-14 text-center gap-20 text-lg w-full items-center border-b border-black">
        ...
        <div className="flex gap-24 text-left justify-start w-full">
          <div className="flex flex-col gap-2">
            <h3 className="font-bold text-lg">1* per dollar</h3>
            <p>Pay as you go</p>
          </div>
      ...
      <div className="bg-sb-gray flex flex-col px-10 py-14 text-center gap-20 text-lg w-full items-center">
        <div className="flex gap-24 text-left justify-start w-full">
          <div className="flex flex-col gap-2">
            <h3 className="font-bold text-lg">2* per dollar</h3>
